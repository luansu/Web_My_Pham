...
public class EmployeeDAOImp implements IEmployeeDAO{
	...
	/*
	 * public static void main(String[] args) { try { new DBConnectionSQLServer();
	 * IEmployeeDAO d = new EmployeeDAOImp(); List<EmployeeModels> listEmp =
	 * d.findByJob("Shipper"); for (EmployeeModels i : listEmp) {
	 * System.out.println(i.getEmployeeID()); } } catch (Exception e) {
	 * e.printStackTrace(); } }
	 */
}
