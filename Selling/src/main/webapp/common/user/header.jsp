...
<body>
	<nav class="navbar navbar-expand-xxl bg-body-tertiary">
		<div class="container-fluid d-flex justify-content-between">
			...
			<form class="d-flex" role="search" action="searchProduct" method="post">
				<div style="display: flex-column; align-items: center;">
				<button id="searchButton" style="background: none; border: none;">
  					<i class="fa-solid fa-magnifying-glass" style="margin-right: 10px;"></i>
				</button>

					<input class="form-control me-2" type="search" placeholder="Search"
						aria-label="Search" style="width: 500px;" name="searchProduct">
				</div>
			</form>

			<span class="navbar-text"> Đăng nhập</span>
				
			<span><a href="<c:url value='/user/findCartByCartID?cartID=${cartID}'/>">
				<i class="fa-solid fa-cart-shopping"></i>
			</a>(${countCartItem}) </span>
		</div>
	</nav>
</body>
</html>