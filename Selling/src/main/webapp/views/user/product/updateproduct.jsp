                        ...
                        <form action="update" method="post">
                            ...
                            <div class="modal-body">					
                                <div class="form-group">
                                    <label>ID</label>
                                    <input value="${P.productID}" name="productID" type="text" class="form-control" readonly required>
                                </div>
                                <div class="form-group">
                                    <label>Name</label>
                                ...
                                <div class="form-group">
                                    <label>Image</label>
                                    <input value="${P.imageURL}" name="imageURL" type="text" class="form-control" required style="object-fit:cover;">
                                </div>
                                <div class="form-group">
                                    <label>Stock</label>
                                    <input value="${P.stock}" name="stock" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Amount</label>
                                    <input value="${P.amount}" name="amount" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Price</label>
