...
<body>
  ...
  <link href='<c:url value="/templates/user/css/product/style.css" />' rel="stylesheet" type="text/css">
  <!-- CAROUSEL BEGIN -->
    ...
    <div class="container-fluid">
      <header class="session_header">MỚI RA MẮT</header>
		...
		<c:if test="${list.size() == 0 }">
			<header class="session_header">CHƯA CÓ SẢN PHẨM THUỘC LOẠI NÀY</header>
		</c:if>
		<c:forEach  var="i" items="${list}">

			<a class="card col-md-2" style="margin-left: 4.75rem;" href="detailProduct?pid=${i.productId }">
		        <img
		          src="${i.imageURL}"
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="row_paragraph">
        <h2>NGHIÊN CỨU BỞI KHOA HỌC TIÊN TIẾN. MANG LẠI HIỆU QUẢ VƯỢT TRỘI</h2>
        <p>NovAge giúp bạn cải thiện làn da ngay từ những dấu hiệu lão hóa đầu tiên cho đến làn da đang bị lão hóa
          nhiều, giúp bạn lấy lại nét tươi trẻ và sức sống của làn da bất chấp mọi độ tuổi.</p>
  ...
  <div class="container">
    <div class="row">
      <svg id="Presentation-beauty-edit-logo" xmlns="http://www.w3.org/2000/svg" width="150" height="80.009"
        ...
        <g transform="translate(0 -74.389)">
          ...
          <path d="M1328.725,320.371l.032-.156-.075.146Z" transform="translate(-1207.219 -223.354)" style="fill: none;">
          </path>
          <g transform="translate(0 74.389)">
            <path
    ...
    <div class="row">
      <p id="text-center" class="centered-text">Chúng tôi tin rằng vẻ đẹp không chỉ đến từ sản phẩm, mà còn là nguồn
        cảm hứng và sự phát triển. Đây là nơi chúng tôi chia sẻ những thông tin, bí quyết, kiến thức làm đẹp để giúp
        bạn luôn tự tin và dẫn đầu xu hướng.</p>
    </div>
  </div>
    ...
    <div class="row">
      <div class="card_news" style="width: 30rem;">
        ...
        <div class="card-body_news">
          ...
          <h5 class="card-title_news">4 Bí Quyết Cho Một Hệ Xương Khỏe Mạnh</h5>
      ...
      <div class="card_news" style="width: 30rem;">
        ...
        <div class="card-body_news">
          ...
          <h5 class="card-title_news">TẠI SAO TÔI KHÔNG THỂ NGỪNG ĂN, ngay cả khi tôi không đói? Giải thích về thực phẩm
            tạo cảm giác ngon miệng</h5>
          <a href="#" class="btn">Tìm hiểu thêm</a>
        </div>
      </div>
    </div>
      ...
      <ul class="commit_ul">
        ...
        <li class="commit_li">
          ...
          <div class="commit_content">
            ...
            <p>Được hoàn tiền 15% giá trị đơn hàng khấu trừ vào đơn hàng tiếp theo (với Khách hàng VIP)</p>
          </div>
        </li>
        <li class="commit_li">
          <div class="commit_img">
          ...
          <div class="commit_content">
            ...
            <p>Được mua sản phẩm của Oriflame với giá ưu đãi giảm 10% trên đơn hàng đầu tiên</p>
          </div>
        </li>
      </ul>
    </section>
  ...
  <div class="grid_template">
    ...
    <p class="item2">Vì chúng tôi đến từ Thụy Điển nên chúng tôi có triết lý riêng về vẻ đẹp và cách mà chúng tôi phát
      triển sản phẩm. Ngay từ những ngày đầu, chúng tôi luôn rất trân trọng thiên nhiên, điều này đóng vai trò quan
      trọng trong mọi hoạt động và tạo dựng nên danh tiếng Oriflame khi mang đến những sản phẩm an toàn, đáng tin cậy
