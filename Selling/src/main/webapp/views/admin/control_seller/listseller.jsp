										...
										<td>
											<ul class="list-inline mb-0">
												<li class="list-inline-item"><a
													href="sellerdetail?id=${i.employeeId }" data-bs-toggle="tooltip"
			...
			<div class="col-sm-6">
				<div class="float-sm-end">
					<ul class="pagination mb-sm-0">
						...
						<c:if test="${page>1 }">
							<li class="page-item"><a href="listseller?page=${page - 1}"
								class="page-link"><i class="mdi mdi-chevron-left"></i></a></li>
						</c:if>
						<c:forEach var="i" begin="1" end="${num }">
							<c:if test="${i==page }">
								<li class="page-item active"><a href="listseller?page=${i}"
