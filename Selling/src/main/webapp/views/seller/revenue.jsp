...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-2 border-end">
            <div class="card mt-4">
                <div class="card-header" data-bs-toggle="collapse" href="#collapseExample1">
                    Quản lý đơn hàng
                </div>
                <div class="collapse" id="collapseExample1">
                    <div class="card-body">
                        <div class="list-group">
                            ...
                            <a href="#" class="list-group-item list-group-item-action">Đơn hủy</a>
                            <a href="#" class="list-group-item list-group-item-action">Hoàn tiền</a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="card mt-3">
                <div class="card-header" data-bs-toggle="collapse" href="#collapseExample2">
                    Quản lý sản phẩm
                </div>
                <div class="collapse" id="collapseExample2">
                    <div class="card-body">
                        <div class="list-group">
                            <a href="#" class="list-group-item list-group-item-action">Tất cả</a>
                            <a href="#" class="list-group-item list-group-item-action">Thêm sản phẩm</a>
                            <a href="#" class="list-group-item list-group-item-action">Sản phẩm và vi phạm</a>
                            <a href="#" class="list-group-item list-group-item-action">Cài đặt sản phẩm</a>
                        </div>
                    </div>
                </div>
            </div>
