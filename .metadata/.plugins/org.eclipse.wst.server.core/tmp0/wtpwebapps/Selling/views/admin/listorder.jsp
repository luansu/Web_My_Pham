...
<button type="button" class="btn btn-outline-primary"><a href="/views/admin/listshipper.jsp">Shipper</a> </button>
...
<div class="container">
    <div class="row align-items-center">
        <div class="col-md-6">
            <div class="mb-3">
                <h5 class="card-title">Thông tin khách hàng <span class="text-muted fw-normal ms-2">(834)</span></h5>
            </div>
        </div>
    </div>
    <div class="row">
